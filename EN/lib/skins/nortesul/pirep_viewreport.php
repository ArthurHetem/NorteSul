...
<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(<?php echo SITE_URL; ?>/lib/skins/avianca/images/img_bg_2.jpg)">
  ...
  <li>Home</li>
  <li>Operations</li>
  <li class="active"><b>Flight <?php echo $pirep->code . $pirep->flightnum; ?></b></li>
</ol></small>							
						</div>
...
<td width="50%">
<ul>
	<li><strong>Submited By: </strong><a href="<?php echo SITE_URL.'/index.php/profile/view/'.$pirep->pilotid?>">
			<?php echo $pirep->firstname.' '.$pirep->lastname?></a></li>
	<li><strong>Departure: </strong><?php echo $pirep->depname?> (<?php echo $pirep->depicao; ?>)</li>
	<li><strong>Arrival: </strong><?php echo $pirep->arrname?> (<?php echo $pirep->arricao; ?>)</li>
	...
	<li><strong>Submit Date: </strong> <?php echo date(DATE_FORMAT, $pirep->submitdate);?></li>
	<?php
	if($pirep->route != '')
	{
