                ...
                if(Auth::LoggedIn())
                    {
                        if(PilotGroups::group_has_perm(Auth::$usergroups, ACCESS_ADMIN))
                        {
                            echo '<form method="link" action="'.SITE_URL.'/index.php/screenshots/approval_list">
                                <input class="btn-flat btn btn-success" type="submit" value="List of Screenshots waiting approval"></form><br />';
                        }
                        echo '<form method="link" action="'.SITE_URL.'/index.php/screenshots/upload">
                        <input class="btn-flat btn btn-info" type="submit" value="Send a new Screenshot"></form></td>';
                     }
                     else
                     {
                         echo 'Login to react to screenshot or sent your.';
                     }
                     ?>
            </td>
        </tr>
