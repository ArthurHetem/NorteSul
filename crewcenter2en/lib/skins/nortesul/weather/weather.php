<section class="content-header">
	...
	<div class="row">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<div class="alert alert-info">This information is for flight simulation only. Do not use it for any other purpose than this.</div>
			...
			<table id="tabledlist" class="tablesorter table table-hover">
				<tbody><tr>
					...
					<td style="vertical-align: middle;"><input type="submit" name="myform" value="send" class="btn btn-flat btn-primary" style="text-transform: uppercase; vertical-align: middle;"></td>
				</tr>
			</tbody></table>
		</form>
		<table id="tabledlist" class="tablesorter table table-hover">
