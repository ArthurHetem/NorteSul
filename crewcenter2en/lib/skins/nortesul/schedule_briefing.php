<section class="content-header">
      <h1>
        <b>Create/Mutate</b> Electronic Briefing NS<?php echo $schedule->flightnum; ?>
      </h1>
    </section>
		...
		<div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Informations<small> NS<?php echo $schedule->flightnum; ?> | <?php echo date("d.m.Y");?> | <?php echo "{$schedule->depicao}"; ?> - <?php echo "{$schedule->arricao}"; ?></small></h3>
            </div>
            <!-- /.box-header -->
...
<section class="col-lg-4 connected">
            <div class="box box-primary">
                    ...
                    <h3 class="box-title">Mutate  NS<?php echo "{$schedule->flightnum}"; ?></h3>
                </div>
                <div class="box-body table-responsive">
<table class="table table-hover">
                ...
                <tr>
                                        <td>STD change</td>
                        <td><select class="form-control" name="deph"><option value="1" selected="selected">Select hours</option>
...
<td><select class="form-control" name="depm"><option value="55" selected="selected">Select minutes</option>
            ...
            <option value="59">59</option>
                ...
                <tr>
                        <td>Route<br><sup>Leave blank for dispatch</sup><br><a href="http://rfinder.asalink.net/free/" id="rflink" target="_blank"><img class="routeimg" style="width:41px;height:17px;padding:2px 0px;margin-right:0px;margin-left:0px" src="https://www.simbrief.com/images/routefinder.png" alt="RouteFinder" title="RouteFinder"></a></td>
...
<section class="col-lg-4 connected">
            <div class="box box-primary">
                           <div class="box-header with-border">
                    <h3 class="box-title">Options/Create NS<?php echo "{$schedule->flightnum}"; ?></h3>
                    </div>
                <div class="box-body table-responsive">
<table class="table table-hover">
                <tbody>
                                
                                <tr><td>Estimated PAX<br><sup>PAX: 74.4 Kgs / BAG: 25 Kgs</sup></td>
...
foreach($allaircraft as $aircraft)
			...
			if($aircraft->registration == $schedule->registration)
			{
                ...
                <td>Estimated cargo<br><sup>in tons</sup></td>
...
foreach($allaircraft as $aircraft)
			...
			if($aircraft->registration == $schedule->registration)
			{
				...
				<tr>
                        <td>Extra Fuel<br><sup>in tons</sup></td>
                ...
                <tr>
						...
						3nput type="hidden" name="tlr" value="0"><input type="checkbox" name="tlr" value="1"></td>
                </tr>
                <tr>
                        <td>NOTAM</td>
...
foreach($allaircraft as $aircraft)
			...
			echo $aircraft->icao;
                         ...
                         ?>">
                                ...
                                <select style="display:none;" class="form-control" name="maps"><option value="detail">Detailed</option><option value="simple">Simple</option><option value="none">None</option></select>
                                
                                
                        <input type="hidden" class="form-control" name="manualrmk" placeholder="Remarks" value="NorteSul Virutal Limits">
...
<input type="hidden" name="depm" value="<?php echo $deptimes[1]?>">    
                                ...
                                <div class="box-body"><input type="button" class="btn btn-flat btn-primary" onclick="simbriefsubmit('http://nortesulvirtual.com/crewcenter2pt/index.php/SimBrief');" value="Request Crew Flight Briefing Pack">

                                <p><em><strong>Note: Remember to sign up for your free SimBrief account before using this feature. It won't work without it!</strong></em></p>   
    	

                                
                                <a id="<?php echo $schedule->id; ?>" class="addbid" style="color: #00ff00" href="<?php echo SITE_URL;?>/index.php/schedules/addbid"><button type="button" class="btn btn-flat btn-danger">Accept</button></a>
                
                <p style="color: #ff0000"><i>No E-Brief generated</i></p>                            
                         </div>
                    </div>
                </div></section>
				<section class="col-lg-4 connected">
