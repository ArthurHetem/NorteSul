...
class Exams_admin extends CodonModule {
    public function index() {
        if(!ExamsData::check_admin(Auth::$userinfo->pilotid)) {
            ...
            Template::Show('exams/frontpage_main.php');
            return;
        //header('Location: '.url('/'));
        }
        ...
        if($this->post->action == 'edit_admin_setting') {
            ...
            Template::Show('exams/exam_admin.php');
        }
    }
    ...
    public function view_current_exams() {
        Template::Set('exams', ExamsData::get_exams_admin());
        Template::Show('exams/exam_list_admin.php');
    }

    public function view_current_questions() {
        Template::Set('questions', ExamsData::get_questions_admin());
        Template::Show('exams/exam_question_list.php');
    }
    ...
    public function view_pilot() {
        ...
        Template::Show('exams/exam_view_pilot.php');
    }
    ...
    public function edit_pilot_record() {
        ...
        Template::Show('exams/exam_edit_pilot_record.php');
    }
    ...
    protected function save_edit_record() {
        ...
        //Template::Show('exam_view_pilot.php');
    }
    ...
    public function see_exam_revisions() {
        ...
        Template::Show('exams/exam_revisions.php');
    }
    ...
    public function edit_questions() {
        ...
        Template::Show('exams/exam_question_edit_list.php');
    }

    public function edit_question() {
        $id = $_GET['id'];
        Template::Set('question', ExamsData::get_question($id));
        Template::Show('exams/exam_question_edit_form.php');
    }
    ...
    public function new_test_form() {
        Template::Show('exams/exam_new_test_form.php');
    }
    ...
    public function new_question_form() {
        Template::Set('exams', ExamsData::get_exams_admin());
        Template::Show('exams/exam_new_question_form.php');
    }
    ...
    public function new_revision_form() {
        Template::Show('exams/exam_new_revision_form.php');
    }
    ...
    public function view_revision_reasons() {
        ...
        Template::Show('exams/exam_revision_list.php');
    }
    ...
    public function edit_reason() {
        ...
        Template::Show('exams/exam_revision_edit.php');
    }
    ...
    public function get_setting_info() {
        ...
        Template::Show('exams/exam_edit_setting.php');
    }
    ...
    public function assign_exams_pilotlist() {
        ...
        Template::Show('exams/exam_assign_list.php');
    }
    ...
    public function edit_admin_list()    {
       Template::Set ('pilots', PilotData::GetAllPilots());
       Template::Show('exams/exam_assign_admin.php');
    }
    ...
    public function edit_admin(){
        ...
        Template::Show('exams/exam_edit_admin.php');
    }
