...
<!-- Main content -->
    <section class="content container-fluid">
		<div class="row">
		  <h1 class="page-title">Flight Schedule <small>Schedule Generated by the System</small></h1>
			<div class="row">
                                            ...
                                            <table class="table table-hover table-light">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th> <center><strong>Flight Number</strong> </th>
                                                        <th> <center><strong>Aircraft</strong> </th>
                                                        <th> <center><strong>Departure</strong> </th>
                                                        <th> <center><strong>Arrival</strong> </th>
                                                        <th> <center><strong>Duration</strong> </th>
                                                    </tr>
                                                </thead>
												<tbody>
												  <?php
...
<form name="bidAll" id="bidAll" action="<?php echo SITE_URL?>/index.php/randomflights/bidAll" method="post">
	...
	<p>
                                            <td>
                                                ...
                                                <div class="col-md-9">
                                                <a href="<?php echo SITE_URL?>/index.php/randomflights" class="btn btn-sm red"> New Schedule
                                                ...
                                                <span class="ladda-label">Book</span>
                                                </button>
                                                </td>
            </table>
        </div>
