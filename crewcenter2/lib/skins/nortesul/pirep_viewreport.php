...
<section class="content-header bg-white espaca">
    ...
    <h1>Revisão de <strong>PIREP</strong></h1>
  ...
  <div class="row">
        <div class="col-md-12">
          <div class="box box-widget widget-user">
              ...
              <div class="widget-user-header bg-white">
                  <h4 class="widget-user-username text-center"><?php echo $pirep->code . $pirep->flightnum; ?></h4>
                  <h5 class="widget-user-desc text-center"><?php echo date(DATE_FORMAT, $pirep->submitdate);?></h5>
              </div>
            </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="box box-widget widget-user">
              <!-- Add the bg color to the header using any of the bg-* classes -->
              <div class="widget-user-header bg-white">
                  <h4 class="widget-user-username text-center"><?php echo $pirep->firstname;?> <?php echo $pirep->lastname;?></h4>
                  <h5 class="widget-user-desc text-center">
                      Tripulante Responsável
                  </h5>
              </div>
              <div class="box-body">
								<b>Origem</b> <div class="pull-right"><?php echo $pirep->depicao; ?></div>
								<hr>
								<b>Destino</b> <div class="pull-right"><?php echo $pirep->arricao; ?></div>
								<hr>
								<b>Duração</b> <div class="pull-right"><?php echo $pirep->flighttime_stamp; ?></div>
								<hr>
								<b>Distância</b> <div class="pull-right"><?php echo $pirep->distance; ?> NM</div>
								<hr>
								<?php if ($pirep->flighttype == "C"){
									echo '<b>Carga</b> <div class="pull-right">'.$pirep->load.' KGS</div>';
								}else {
									echo '<b>Passageiros</b> <div class="pull-right">'.$pirep->load.'</div>';
								}?>
								<hr>
								<b>Comb. utilizado</b> <div class="pull-right"><?php echo $pirep->fuelused; ?> KGS</div>
								<hr>
								<b>Pagamento do piloto</b> <div class="pull-right"> v$ <?php echo $pirep->pilotpay; ?></div>
								<br>
								<br>
			...
			echo '<span class="label label-warning">Em analíse</span>';
		}elseif($pirep->accepted == PIREP_INPROGRESS){
			echo '<span class="label label-info">Em progresso</span>';
								...
								<div class="box-footer bg-navy" height="150px"><h1 class="text-center"><?php echo $pirep->source; ?></h1></div>
            </div>
        </div>
				<?php
				//EFICIENCIA
            ...
            <div class="col-md-6">
              <div class="box box-solid">
                  <div class="box-header with-border">
                      ...
                      <h3 class="box-title">Classificação do  <strong>PIREP</strong></h3>
                  </div>
                  <div class="box-body">
										<div class="col-md-3">
											<div class="c100 p<?php echo $calculou; ?> green">
                    <span><?php echo $calculou; ?>% <i class="fa fa-leaf"></i></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
                </div>
								<div class="text-center">Eficiência</div>
										</div>
                    ...
                    <span><?php echo $pctPouso; ?> %</span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
                </div>
								<div class="text-center">Suavidade do Pouso</div>
										</div>
                  </div>
              </div>
            </div>
              ...
              <div class="box box-solid">
                  <div class="box-header with-border">
                      ...
                      <h3 class="box-title">Rota do  <strong>PIREP</strong></h3>
                  </div>
                  <div class="box-body">
              ...
              <div class="box box-solid">
                  <div class="box-header with-border">
                      ...
                      <h3 class="box-title">Comentários do  <strong>PIREP</strong></h3>
                  </div>
                  <div class="box-body table-responsive">
										...
										{
										echo '<h3>Comments</h3>
											<table id="tabledlist" class="tablesorter table table-bordered">
										<thead>
										<tr>
										<th>Autor</th>
										<th>Comentário</th>
										...
										echo '<div class="callout callout-danger"><p>Nenhum comentário foi adicionado a esse <b>PIREP</b>.</p>
              </div>';
									}
										?>
                  </div>
              ...
              <div class="box box-solid">
                  <div class="box-header with-border">
                      ...
                      <h3 class="box-title">PIREP <strong>codificado</strong></h3>
                  </div>
                  <div class="box-body table-responsive">
										<?php
...
var dep_location = new google.maps.LatLng(<?php echo $pirep->deplat; ?>,<?php echo $pirep->deplng; ?>);
var arr_location = new google.maps.LatLng(<?php echo $pirep->arrlat; ?>,<?php echo $pirep->arrlng; ?>);
...
var depMarker = new google.maps.Marker({
		 ...
		 title: "<?php echo $pirep->depname;?>",
		 animation:google.maps.Animation.DROP
 });
 var departureinfo = '<?php echo $pirep->depname;?>, you take off from here';
 ...
 /*Arrival START*/
 var arrivalinfo = '<?php echo $pirep->arrname;?>, you will be arriving here';
