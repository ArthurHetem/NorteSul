	...
	<div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Administração dos Exames</h3>
            </div>
            <!-- /.box-header -->
...
<center>
    <table class="table table-bordered table-hover">
        ...
        ?>
        <tr>
            <td colspan="6" bgcolor="#cccccc"><b>Exames Aguardando Aprovação:</b></td>
        </tr>

        <?php
        if (!$unapproved) {echo '<tr><td colspan="6" class="badge bg-red">Nenhum Exame aguardando aprovação.</td></tr>';}
        else {
            echo '<tr>
                    <td colspan="4" align="right">Aprovado no Exame</td>
		...
		<td><a href="'.SITE_URL.'/index.php/Exams_admin/save_approve_result?id='.$awaiting->id.'&approve=1" class="badge bg-green">Approvar</a> / <a href="'.SITE_URL.'/index.php/Exams_admin/save_approve_result?id='.$awaiting->id.'&approve=2" class="badge bg-red">Reprovar</a></td>
		</tr>';
            }
        }
        ?>
