                ...
                if(Auth::LoggedIn())
                    {
                        if(PilotGroups::group_has_perm(Auth::$usergroups, ACCESS_ADMIN))
                        {
                            echo '<form method="link" action="'.SITE_URL.'/index.php/screenshots/approval_list">
                                <input class="btn-flat btn btn-success" type="submit" value="Lista de Screenshots Aguardado Aprovação"></form><br />';
                        }
                        echo '<form method="link" action="'.SITE_URL.'/index.php/screenshots/upload">
                        <input class="btn-flat btn btn-info" type="submit" value="Enviar nova Screenshot"></form></td>';
                     }
                     else
                     {
                         echo 'Login para reagir a screenshots ou enviar a sua.';
                     }
                     ?>
            </td>
        </tr>
