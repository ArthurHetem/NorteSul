<table class="table">
	<tr><th width="10%"><h4>Pilot ID</h4></th><th width="20%"><h4>Name</h4></th><th><h4>Rank</h4></th><th><h4>Distane</h4></th></tr>
	<?php
	if(!$bestdistancedays)
		{
	?>
			<tr><td align="center" colspan="4" class="label label-danger text-center">No reports today!</td></tr>
	<?php
		}
	else
		{
