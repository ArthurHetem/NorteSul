...
<form id="flashForm" action="<?php echo adminaction('/operations/aircraft');?>" method="post">
<dl>
<dt>* Aircraft ICAO Code</dt>
<dd><input id="icao" name="icao" type="text" value="<?php echo $aircraft->icao; ?>" />
<button id="lookupAircraft" onclick="lookupaircraft(); return false;">Look Up</button></dd>
<dd><div id="statusbox"></div></dd>
<dt>* Aircraft Name/Type (i.e B747-400)</dt>
<dd><input id="name" name="name" type="text" value="<?php echo $aircraft->name; ?>" /></dd>

<dt>* Full Name (Boeing 747-400 Combi)</dt>
<dd><input id="fullname" name="fullname" type="text"  value="<?php echo $aircraft->fullname; ?>" /></dd>
...
<dd><input id="maxpax" name="maxpax" type="text"  value="<?php echo $aircraft->maxpax; ?>" />
	<p>The maximum number of passengers that can be flown on this aircraft, for passenger or charter flights</p>
</dd>

<dt>* Maximum Cargo</dt>
<dd><input id="maxcargo" name="maxcargo" type="text"  value="<?php echo $aircraft->maxcargo; ?>" />
...
<dt>Range</dt>
<dd><input id="range" name="range" type="text"   value="<?php echo $aircraft->range; ?>" /></dd>

<dt>Weight</dt>
<dd><input id="weight" name="weight" type="text" value="<?php echo $aircraft->weight; ?>" /></dd>

<dt>Cruise</dt>
<dd><input id="cruise" name="cruise" type="text"  value="<?php echo $aircraft->cruise; ?>" /></dd>
